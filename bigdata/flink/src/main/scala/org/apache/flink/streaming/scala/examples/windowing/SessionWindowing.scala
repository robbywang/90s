...
//  implicit val typeInfo = TypeInformation.of(classOf[(String, Long, Int)]) //Add this here
...
//    env.setStreamTimeCharacteristic(TimeCharacteristic.ProcessingTime)
    ...
    val input = List(
      ...
      ("c", 11L, 1),
      // 由于设置了allowedLateness， 会使得窗口再次被触发.
      ("a", 2L, 8),
      ("robby", 100L, 8),
      ("robby", 102L, 8),
      ("c", System.currentTimeMillis()-2L, 1),
      ("c", System.currentTimeMillis()+1L, 1),
      ("c", System.currentTimeMillis()+5L, 1)
    )
